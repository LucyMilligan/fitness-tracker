  ...
  async function fetchActivities() {
    try {
      ...
      if (startDate > endDate) {
        return {
          success: false,
          error: `No activity data to plot. Please enter correct start and end dates.`,
        };
      }
      ...
      if (!response.ok) {
        return {
          success: false,
          error: `No activity data to plot for User ID ${userId} between the given dates. Please try again.`,
        };
      }
      ...
      return {
        success: false,
        error: `Oops, something went wrong on our end. Not able to plot activity data right now.`,
      };
    }
  }
    ...
    <>
      <main>
        ...
        <form
          ...
          className="flex gap-2 flex-col justify-end"
        >
          {/* User ID */}
          <div className="flex justify-end items-center gap-4">
            <label htmlFor="user_id" className="w-37 text-right font-12">
              User ID:
            </label>
            <input
              type="text"
          ...
          {/* start date */}
          <div className="flex justify-end items-center gap-4">
            <label htmlFor="start_date" className="w-37 text-right font-12">
              Start date:
            </label>
            <input
              type="date"
          ...
          {/* end date */}
          <div className="flex justify-end items-center gap-4">
            <label htmlFor="end_date" className="w-37 text-right font-12">
              End date:
            </label>
            <input
              type="date"
          ...
          {/* plot y axis */}
          <div className="flex justify-end items-center gap-4">
            <label htmlFor="plot_type" className="w-80 text-right font-12">
        ...
        <div className="flex pt-15 justify-center items-center">
          <Plot
            ...
            yAxisTitle={plotYAxis}
            xAxisTitle={plotXAxis}
            chartData={plotData}
          />
        </div>
